...
public:
    ...
    void setCar(const string &model,string makeDate,int km){
        numCars++;
    this->model=model;
...
int main()
{
    ...
    nissan.showCar();
    Car mecedes;
     mecedes.setCar("Mecedes","2005",13254);
    mecedes.showCar();
    cout<<"******"<<endl;
    cout<<"num of cars ="<<Car::getNumCars()<<endl;
